  ...
  <div class="container">
    <nav class="row navbar navbar-expand-lg navbar-light bg-white">
        <a href="{{route('home')}}" class="navbar-brand">
            <img src="{{ url('frontend/images/lg.png') }}" alt="logoNomads">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navb">
            <ul class="navbar-nav ml-auto mr-3">
                ...
                <li class="nav-item mx-md-2">
                        <a href="#popular-content" class="nav-link">Paket Travel</a>
                </li>
            ...
            @guest
                <!-- mobile button -->
                <form class="form-inline d-sm-block d-md-none" action="{{url('login')}}">
                    @csrf
